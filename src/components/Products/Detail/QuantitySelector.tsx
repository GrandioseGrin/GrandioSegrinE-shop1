...
const packOptions: PackOption[] = [
  ...
  { label: "1 Pack", multiplier: 6 },
  { label: "2 Packs", multiplier: 12 },
];
    ...
    <div>
      ...
      <div className="grid grid-cols-3 gap-2 sm:gap-4 mt-2">
        ...
        flex flex-col items-center justify-center border-4 rounded-[12px] py-2 px-4`}
              disabled={isDisabled}
            >
              <Paragraph1 className=" font-bold">{option.label}</Paragraph1>
              <Paragraph1>
                (
      ...
      <div className="flex items-center gap-4 py-2">
        <div className="border- border-primary my-4 gap-4 items-center flex rounded-[12px] border w-full px-4 py-2">
